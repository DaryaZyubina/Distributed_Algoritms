...
public final class Lab0 {
    ...
    public static final void main(String[] args) {
        ...
        Topology topology3 = new Topology() {
            {
                ...
                link(1, 3, 2000, 0.5).bidirectional();
                link(2, 3, 4000, 0.5).bidirectional();
            }
        };
        ...
        Scenario scenario3 = new Scenario(Main.class){
            {
                command(1, "S2000:PHello, Sam!");
                command(2, "S3000:PHello, Dean!");
                command(3, "S4000:LHello Cas!");
            }
        };
